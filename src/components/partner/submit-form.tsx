...
export function SubmitForm() {
    ...
    return (
      <div className="mx-auto max-w-lg py-12 text-center">
        ...
        <div className="mt-6 flex justify-center gap-3">
          ...
          <a
            href="/partner/submit"
            className="rounded-lg bg-[#0066FF] px-4 py-2 text-sm font-semibold text-white hover:bg-[#0050CC]"
          >
            Submit Another
          </a>
        </div>
  ...
  const inputClass =
    "block w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm shadow-sm transition-colors focus:border-[#0066FF] focus:outline-none focus:ring-1 focus:ring-[#0066FF]";
        ...
        <div className="mt-6 flex justify-between">
          ...
          {step < STEPS.length - 1 ? (
            <button
              type="button"
              onClick={nextStep}
              className="flex items-center gap-1.5 rounded-lg bg-[#0066FF] px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#0050CC]"
            >
              Next
            ...
            <button
              type="submit"
              disabled={submitting}
              className="flex items-center gap-1.5 rounded-lg bg-[#0066FF] px-6 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#0050CC] disabled:opacity-60"
            >
