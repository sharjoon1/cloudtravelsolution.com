      ...
      <div className="flex flex-col gap-3 border-b border-gray-100 p-4 sm:flex-row sm:items-center sm:justify-between">
        <form onSubmit={handleSearch} className="relative flex-1 sm:max-w-xs">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 py-2 pl-9 pr-3 text-sm focus:border-[#0c6cbc] focus:outline-none focus:ring-1 focus:ring-[#0c6cbc]"
          />
        </form>
        ...
        <select
          ...
          className="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#0c6cbc] focus:outline-none"
        >
                ...
                <tr key={req.id} className="transition-colors hover:bg-gray-50/50">
                  <td className="px-4 py-3">
                    <Link
                      ...
                      className="font-mono text-sm font-semibold text-[#0c6cbc] hover:underline"
                    >
                      {req.trackingCode}
                    </Link>
                  </td>
