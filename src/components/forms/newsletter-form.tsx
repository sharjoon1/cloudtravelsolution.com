  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 px-5 py-2.5 bg-[var(--color-secondary)] hover:bg-[var(--color-secondary-dark)] text-[var(--color-primary-dark)] font-semibold rounded-lg transition-colors text-sm disabled:opacity-50 shrink-0"
      >
        {isSubmitting ? (
