  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 px-5 py-2.5 bg-[#0066FF] hover:bg-[#0050CC] text-white font-semibold rounded-lg transition-colors text-sm disabled:opacity-50 shrink-0"
      >
        {isSubmitting ? (
