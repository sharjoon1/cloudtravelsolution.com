  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 px-5 py-2.5 bg-[#673de6] hover:bg-[#5025d1] text-white font-semibold rounded-lg transition-colors text-sm disabled:opacity-50 shrink-0"
      >
        {isSubmitting ? (
