            ...
            return (
              <div key={item.label}>
                ...
                {hasChildren && (
                  ...
                  >
                    <div className="ml-3 pl-3 border-l-2 border-[#00E68A]/30 space-y-0.5 pb-2">
                      <Link
                        href={item.href}
                        className="block px-3 py-2 text-sm font-medium text-[#00E68A] hover:bg-white/10 rounded-md transition-colors"
                        onClick={() => setMobileMenuOpen(false)}
                      >
                        View All {item.label}
                      </Link>
