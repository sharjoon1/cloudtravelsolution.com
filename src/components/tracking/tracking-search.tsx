        ...
        <button
          ...
          className={`flex-1 rounded-md px-3 py-2 text-sm font-medium transition-colors ${
            searchType === "tracking-code"
              ? "bg-white text-[#265ab2] shadow-sm"
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 py-2.5 pl-9 pr-3 text-sm focus:border-[#265ab2] focus:outline-none focus:ring-1 focus:ring-[#265ab2]"
          />
        </div>
        <button
          type="submit"
          disabled={loading || query.trim().length < 3}
          className="rounded-lg bg-[#0cfcbc] px-6 py-2.5 text-sm font-semibold text-[#265ab2] transition-colors hover:bg-[#0adba5] disabled:opacity-50"
        >
