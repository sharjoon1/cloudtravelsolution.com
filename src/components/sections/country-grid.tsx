          ...
          {POPULAR_COUNTRIES.map((country) => {
            ...
            return (
              <Link
                ...
                className="group relative flex flex-col rounded-2xl bg-[#f2f3f6] border border-[#dadce0]/60 hover:border-[#673de6]/30 hover:shadow-lg transition-all duration-300 overflow-hidden"
              >
                {/* Top accent bar */}
