          ...
          {POPULAR_COUNTRIES.map((country) => {
            ...
            return (
              <Link
                ...
                className="group relative flex flex-col rounded-2xl bg-[#e3ebf9] border border-[#dadce0]/60 hover:border-[#357df9]/30 hover:shadow-lg transition-all duration-300 overflow-hidden"
              >
                {/* Top accent bar */}
