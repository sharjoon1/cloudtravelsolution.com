...
export function CTABanner({ ctaData, siteSettings }: CTABannerProps) {
  ...
  return (
    <section className="py-16 lg:py-20 bg-gradient-to-r from-[#0A1A44] to-[#061230] text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href={buttonLink}
            className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#0066FF] hover:bg-[#0050CC] text-white font-semibold rounded-lg transition-colors shadow-lg"
          >
            {buttonText}
