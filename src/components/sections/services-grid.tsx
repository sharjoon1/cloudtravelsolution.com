        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {SERVICES.map((service) => {
            ...
            return (
              ...
              >
                <div className="h-12 w-12 rounded-lg bg-[#0cfcbc]/15 flex items-center justify-center mb-4 group-hover:bg-[#0cfcbc] transition-colors">
                  <Icon className="h-6 w-6 text-[#0cfcbc] group-hover:text-[#094f8a] transition-colors" />
                </div>
                <h3 className="text-lg font-semibold text-[#0c6cbc] mb-2">
                  {service.title}
                </h3>
                <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                  {service.description}
                </p>
                <span className="inline-flex items-center gap-1.5 text-sm font-medium text-[#0cfcbc] group-hover:gap-2.5 transition-all">
                  Learn More
