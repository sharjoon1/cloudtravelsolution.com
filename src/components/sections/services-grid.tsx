        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {SERVICES.map((service) => {
            ...
            return (
              ...
              >
                <div className="h-12 w-12 rounded-lg bg-[#009e7a]/15 flex items-center justify-center mb-4 group-hover:bg-[#0cfcbc] transition-colors">
                  <Icon className="h-6 w-6 text-[#009e7a] group-hover:text-[#094f8a] transition-colors" />
                </div>
