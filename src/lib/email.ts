...
export async function sendLeadNotification(data: HeroLeadFormData): Promise<EmailResult> {
  ...
  const html = emailLayout(
    ...
    `<p style="margin:16px 0 0;"><a href="${process.env.NEXT_PUBLIC_SITE_URL || "http://localhost:3000"}/admin/collections/leads" style="display:inline-block;padding:10px 20px;background:#673de6;color:#ffffff;text-decoration:none;border-radius:6px;font-size:14px;font-weight:600;">View in Admin</a></p>`
  );
...
export async function sendLeadConfirmation(data: HeroLeadFormData): Promise<EmailResult> {
  ...
  const html = emailLayout(
    ...
    `<p style="color:#374151;font-size:15px;line-height:1.6;margin:0 0 16px;">
      We received your travel inquiry for <strong>${dest}</strong>. Our team will contact you within <strong style="color:#673de6;">2 hours</strong> to discuss your trip.
    </p>
...
export async function sendInquiryNotification(data: VisaInquiryFormData): Promise<EmailResult> {
  const html = emailLayout(
    ...
    `<p style="margin:16px 0 0;"><a href="${process.env.NEXT_PUBLIC_SITE_URL || "http://localhost:3000"}/admin/collections/inquiries" style="display:inline-block;padding:10px 20px;background:#673de6;color:#ffffff;text-decoration:none;border-radius:6px;font-size:14px;font-weight:600;">View in Admin</a></p>`
  );
...
export async function sendCallbackNotification(data: CallbackFormData): Promise<EmailResult> {
  const html = emailLayout(
    ...
    `<p style="color:#673de6;font-size:14px;font-weight:600;margin:16px 0 0;">Please call them as soon as possible.</p>`
  );
...
export async function sendContactConfirmation(data: ContactFormData): Promise<EmailResult> {
  const html = emailLayout(
    ...
    `<p style="color:#374151;font-size:15px;line-height:1.6;margin:0 0 16px;">
      We received your message and will respond within <strong style="color:#673de6;">24 hours</strong>.
    </p>
