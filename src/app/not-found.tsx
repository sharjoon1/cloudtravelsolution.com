  ...
  return (
    <div className="min-h-screen bg-[#e3ebf9] flex items-center justify-center">
      <div className="mx-auto max-w-2xl px-4 py-16 text-center">
        {/* 404 Number */}
        <div className="text-[120px] sm:text-[160px] font-bold leading-none bg-gradient-to-r from-[#0c6cbc] to-[#0c6cbc] bg-clip-text text-transparent">
          404
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-12">
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#0cfcbc] hover:bg-[#0adba5] text-[#0c6cbc] font-semibold rounded-lg transition-colors"
          >
