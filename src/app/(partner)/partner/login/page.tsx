      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <button
            ...
            className="mt-6 w-full rounded-lg bg-[#673de6] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#5a31d4] disabled:opacity-60"
          >
