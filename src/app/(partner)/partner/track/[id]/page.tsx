  ...
  if (!request) {
    return (
      <div className="py-20 text-center">
        ...
        <Link href="/partner/dashboard" className="mt-4 inline-block text-sm text-[#357df9] hover:underline">
          Back to Dashboard
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="font-mono text-2xl font-bold text-[#357df9]">
              ...
              <div className="mt-4 space-y-3 border-t border-gray-100 pt-4">
                ...
                {newFiles.length > 0 && (
                  <button
                    ...
                    disabled={uploading}
                    className="rounded-lg bg-[#00E68A] px-4 py-2 text-sm font-semibold text-[#265ab2] hover:bg-[#00CC7A] disabled:opacity-60"
                  >
